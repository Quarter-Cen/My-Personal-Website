export default function Hero() {
    return (
      <div className="hero bg min-h-screen bg-cover " style={{ backgroundImage: "url('/T-pose.png')", backgroundPosition: '10% 20%'}}>
        <div className="hero-content text-center px-4 bg-opacity-80 bg-slate-100 rounded-xl">
